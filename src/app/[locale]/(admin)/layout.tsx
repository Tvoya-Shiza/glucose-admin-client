...
import { PermissionGate } from '@/lib/access/permission-gate';
 ...
 * layout assumes the request has already been authenticated. <PermissionGate>
 * adds the per-route permission check on top of that.
 */
