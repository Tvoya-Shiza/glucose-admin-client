...
import type { BannerRow, BannerStatus } from '@/lib/banners/types';
...
function statusVariant(status: BannerStatus): 'default' | 'secondary' {
    return status === 'publish' ? 'default' : 'secondary';
}

/**
 * BAN-01 — banners table.
 *
 * Mirrors StoriesTable minus the icon column (Advertisement has no icon field).
 *
